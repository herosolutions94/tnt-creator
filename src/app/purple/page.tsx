...
const testimonialImages = [
  { x: 5, y: 8, rotate: -3, scale: 1.0, zIndex: 3, color: "#6a1289", initials: "FA", stars: 5, text: "Actually useful updates every day", name: "Fatima A." },
  ...
  { x: 42, y: 12, rotate: -1, scale: 1.05, zIndex: 4, color: "#6a1289", initials: "PM", stars: 5, text: "Clean, simple and straight to the point", name: "Priya M." },

  { x: 60, y: 45, rotate: 3, scale: 0.9, zIndex: 2, color: "#E63E00", initials: "SA", stars: 5, text: "No spam, just good content", name: "Sam A." },

  { x: 75, y: 10, rotate: -2, scale: 1.0, zIndex: 5, color: "#6a1289", initials: "RK", stars: 5, text: "I check this channel daily now", name: "Raj K." },
  ...
  { x: 30, y: 70, rotate: -4, scale: 1.0, zIndex: 3, color: "#6a1289", initials: "HZ", stars: 5, text: "Always something new being shared", name: "Hassan Z." },
  ...
  { x: 80, y: 55, rotate: -1, scale: 1.02, zIndex: 4, color: "#6a1289", initials: "AC", stars: 5, text: "Joined and stayed for the value", name: "Aisha C." },
];

const stats = [
  { number: "47,200+", label: "Members", icon: "/images/purple-user.png" },
  { number: "$2.8M+", label: "Value Shared", icon: "/images/purple-money.png" },
  { number: "500M+", label: "Reach Insights", icon: "/images/purple-eye.png" },
  { number: "3,000+", label: "Active Discussions", icon: "/images/purple-star.png" },
];
    ...
    <div style={{ background: "#FFFFFF", color: "#0A0A0A", fontFamily: "'Poppins', sans-serif", overflowX: "hidden" }}>
      ...
      >
        ...
        <div style={{
          ...
          height: 500,
          borderRadius: "50%",
          background: "radial-gradient(circle, #6a12890d 0%, transparent 70%)",
          pointerEvents: "none",
        }} />
        ...
        {/* <div style={{
          ...
          inset: 0,
          backgroundImage:
            "linear-gradient(#6a12890d 1px, transparent 1px), linear-gradient(90deg, #6a12890d 1px, transparent 1px)",
          ...
          <Reveal>
            <div style={{ textAlign: "left" }}>
              ...
              <h1 style={{
                ...
                <span style={{
                  color: "#6a1289",
                  background: "linear-gradient(135deg, #6a1289, #590777)",
      ...
      {/* ── TELEGRAM ── */}
      <section id="telegram" style={{ padding: "8rem 1.5rem", background: "#69128914", position: "relative" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "2.5rem", alignItems: "stretch" }}>
            <Reveal>
              <div style={{ background: "#0A0A0A", borderRadius: 32, padding: "3.5rem 2.5rem", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", position: "relative", overflow: "hidden" }}>
                <div style={{ position: "absolute", top: "-20%", right: "-20%", width: "300px", height: "300px", background: "#6a12894a", filter: "blur(80px)", borderRadius: "50%" }} />
                <div style={{ position: "relative", zIndex: 1 }}>
                  <span style={{ color: "#6a1289", fontWeight: 800, fontSize: "0.8rem", letterSpacing: "2px", textTransform: "uppercase" }}>The Inner Circle</span>
                  ...
                  <a href="#" style={{
                    ...
                    background: "#6a1289", color: "#fff", padding: "20px", borderRadius: '50px',
      ...
      {/* ── STORIES ── */}
      <section style={{ padding: "8rem 1.5rem", background: "#f3edf6", color: "#0A0A0A" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: "2rem" }}>
            <span style={{ color: "#6a1289", fontWeight: 800, fontSize: "0.8rem", letterSpacing: "2px" }}>CASE STUDIES</span>
            <h2 style={{ fontSize: "clamp(2.5rem, 6vw, 3rem)", fontWeight: 900, margin: "1rem 0" }}>
              Crazy Success <span style={{ color: "#6a1289" }}>Stories</span>
            </h2>
              ...
              <div key={i} style={{
                ...
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "2rem" }}>
                    <div style={{ width: 50, height: 50, borderRadius: "12px", background: "#6a128932", color: "#6a1289", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800 }}>{s.avatar}</div>
                    <div>
      ...
      >
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "4rem", position: "relative", zIndex: 10 }}>
            <p style={{ color: "#6a1289", fontWeight: 700, fontSize: "0.8rem", letterSpacing: "0.15em", textTransform: "uppercase" }}>
              Social Proof
            </p>
            <h2 style={{ fontWeight: 900, fontSize: "clamp(2.5rem, 6vw, 3.5rem)", color: "#0A0A0A", marginBottom: "1rem", lineHeight: 1.1 }}>
              ...
              <span style={{ color: "#6a1289" }}>& Live Reviews</span>
            </h2>
      ...
      {/* ── COUNTERS ── */}
      <section style={{ padding: "8rem 1.5rem", background: '#6a128919' }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "2.5rem", marginBottom: "5rem" }}>
            <div style={{ background: '#fff', border: `1px solid ${colors.border}`, borderRadius: 32, padding: "4rem 2rem", textAlign: "center", boxShadow: "0 15px 35px rgba(0,0,0,0.03)", position: "relative", overflow: "hidden" }}>
              <div className="flex items-center justify-center mb-6">
                <img src="/images/purple-user.png" alt="Icon" className="w-12 h-12 opacity-90" />
              </div>
            ...
            <div style={{ background: '#fff', border: `1px solid ${colors.border}`, borderRadius: 32, padding: "4rem 2rem", textAlign: "center", boxShadow: "0 15px 35px rgba(0,0,0,0.03)" }}>
              <div className="flex items-center justify-center mb-6">
                <img src="/images/purple-money.png" alt="Icon" className="w-12 h-12 opacity-90" />
              </div>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", background: colors.surface, borderRadius: "40px", border: `1px solid ${colors.border}`, padding: "4.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "4rem", overflow: "hidden", position: "relative", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 200px", display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
            <a
              ...
              style={{
                background: isHovered ? "#770f9c" : colors.accent, color: "#fff", padding: "20px 48px", borderRadius: "50px", fontWeight: 700, fontSize: "1.05rem", textDecoration: "none", transition: "all 0.3s",
                boxShadow: isHovered ? "0 15px 30px #6912892b" : "0 8px 15px #69128944",
              }}
            >
              Join Telegram Now →
            </a>
